...
namespace Toro.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(UserRegisterDto userRegisterDto)
        {
            ...
            var userToReturn = _mapper.Map<UserGeneralDto>(createdUser);

            return CreatedAtRoute("Get", new { controller = "Users", id = createdUser.Id }, userToReturn);
        }
        ...
        public async Task<IActionResult> Login(UserLoginDto userForLoginDto)
        {
            ...
            var user = _mapper.Map<UserGeneralDto>(userFromRepo);
